<template>
  <div>
    <div style="padding: 16px 24px 0 24px">
      <div style="height: 30px; border-bottom: 1px solid #e8e8e8">
        <a href="" style="padding: 3px 15px; border-right: 1px solid #e8e8e8">
    ...
    <div style="padding: 16px 24px" class="s-form">
